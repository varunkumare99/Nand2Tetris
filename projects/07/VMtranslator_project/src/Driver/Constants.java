...
public class Constants
{
    ...
    public static final Integer C_LABEL = 3;
    public static final Integer C_GOTO = 4;
    public static final Integer C_IF = 5;
    public static final Integer C_FUNCTION = 6;
    public static final Integer C_RETURN = 7;
    public static final Integer C_CALL = 8;
